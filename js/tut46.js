...
let reg = /Nikhil/; // This is a regular expression literal in js
reg = /Nikhil/g; // g means global
// reg = /Nikhil/i; // i means case insensitive

// console.log(reg);
// console.log(reg.source);

let s = "This is great code with nikhil and also nikhil bhai";
